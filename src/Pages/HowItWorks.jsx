            ...
            <div className="text-center">
                ...
                <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
                    <div className="p-4 bg-gray-50 rounded-lg shadow">
                        <h3 className="text-xl font-semibold mb-2 text-black">1. Browse Groups</h3>
                        <p className="text-gray-600">Explore a variety of hobby groups based on your interests and location.</p>
                    </div>
                    <div className="p-4 bg-gray-50 rounded-lg shadow">
                        <h3 className="text-xl font-semibold mb-2 text-black">2. Join & Connect</h3>
                        <p className="text-gray-600">Join a group and get in touch with other members. Share ideas and plan activities.</p>
                    </div>
                    <div className="p-4 bg-gray-50 rounded-lg shadow">
                        <h3 className="text-xl font-semibold mb-2 text-black">3. Enjoy the Journey</h3>
